 ...
 *
 */
public class  DrivetrainPIDCommandWithTimeout extends Command {
	double distance;
	...
	boolean isFinished;
	boolean timeoutFinished;
	boolean isTurning;
	//double distanceTraveled = 2000;
	
    public DrivetrainPIDCommandWithTimeout(double distance, boolean isTurning) {
...
//    	}
    	if(timeout.get() % 1 == 0) {
    		if(Math.abs(distanceTraveled - Robot.drive.getDistanceDTBoth()) <= 0.1) {
	...
	protected boolean isFinished() {
        ...
        return isFinished || timeoutFinished;
    }
